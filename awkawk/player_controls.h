...
struct player_controls : device_loss_handler, message_handler
{
	player_controls(Player* player_, window* parent_, IDirect3DDevice9Ptr device_);
	...
	struct skin_definition
	{
		...
		button_definition button_definitions[control_max];
